...
Per-paper `README.md` and `writeup.md` files record the reproduction as it was carried out and scored at the time of publication; the table above carries the referee's final rulings and is the authoritative summary.
